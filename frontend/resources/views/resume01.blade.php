 ...
 <body> 
  <div id="body">
   ...
   <div id="container"> 
    <div class="clearfix"> 
     <div class="content_l"> 
      <div id="resumeScore" style="height: 0px;"> 
      ...
      <div class="basicEdit dn" style="display: block;"> 
        ...
        <table> 
         <tbody> 
          ...
          <tr> 
           ...
           <td> <input type="text" placeholder="姓名" value="李明" name="re_name" id="name" /> </td> 
           <td valign="top"></td> 
           <td> 
            <ul class="profile_radio clearfix reset"> 
             <li class="current"> 男<em></em> <input type="radio" checked="checked" name="re_sex" value="1" /> </li> 
             <li> 女<em></em> <input type="radio" name="re_sex" value="2" /> </li> 
            </ul> </td> 
          </tr> 
          <tr> 
           <td valign="top"> <span class="redstar">*</span> </td> 
           <td> <input type="hidden" id="topDegree" value="" name="re_study" /> <input type="button" value="学历" id="select_topDegree" class="profile_select_190 profile_select_normal" /> 
            <div class="boxUpDown boxUpDown_190 dn" id="box_topDegree" style="display: none;"> 
             <ul>
               @foreach($education as $kk=>$vv) 
              <li id="{{$vv->pro_id}}">{{$vv->pro_name}}</li> @endforeach 
             </ul> 
            </div> </td> 
           <td valign="top"> <span class="redstar">*</span> </td> 
           <td> <input type="hidden" id="workyear" value="" name="re_suffer" /> <input type="button" value="工作年限" id="select_workyear" class="profile_select_190 profile_select_normal" /> 
            <div class="boxUpDown boxUpDown_190 dn" id="box_workyear" style="display: none;"> 
             <ul>
               @foreach($experience as $k=>$v) 
              <li id="{{$v->pro_id}}">{{$v->pro_name}}</li> @endforeach 
             </ul> 
            </div> </td> 
          </tr> 
          <tr> 
          ...
          <tr> 
           <td valign="top"> <span class="redstar">*</span> </td> 
           <td colspan="3"> <input type="text" placeholder="手机号码" value="18644444444" name="re_tel" id="tel" /> </td> 
          </tr> 
          <tr> 
           <td valign="top"> <span class="redstar">*</span> </td> 
           <td colspan="3"> <input type="text" placeholder="接收面试通知的邮箱" value="jason@qq.com" name="re_email" id="email" /> </td> 
          </tr> 
          <tr> 
           <td valign="top"> <span class="redstar">*</span> </td> 
           <td colspan="3"> <input type="text" placeholder="现居住地" value="" name="re_address" /> </td> 
          </tr> 
          <tr> 
           <td valign="top"> </td> 
           <td colspan="3"> <input type="hidden" id="currentState" value="" name="re_current" /> <input type="button" value="目前状态" id="select_currentState" class="profile_select_410 profile_select_normal" /> 
            <div class="boxUpDown boxUpDown_410 dn" id="box_currentState" style="display: none;"> 
             <ul>
               @foreach($work_status as $key=>$val) 
              <li id="{{$val->pro_id}}">{{$val->pro_name}}</li> @endforeach 
             </ul> 
            </div> </td> 
          </tr> 
          <tr> 
       ...
       <!--end #profileForm--> 
       <div class="new_portrait" style="float: right;height: 180px;margin:0;position: relative;width: 120px;"> 
