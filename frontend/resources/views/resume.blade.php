            			...
            			<form id="profileForm" method="post" action="{{URL('postresume')}}">
						  <table>
						    ...
						    <tr>
						      ...
						      <td>
						        <input type="text" placeholder="姓名" value="李明" name="re_name" id="name">
						      </td>
						      <td valign="top"></td> 
						      <td>
						          <ul class="profile_radio clearfix reset">
						            <li class="current">
						           	  	 男<em></em>
						              	<input type="radio" checked="checked" name="re_sex" value="1"> 
						            </li>
						            <li>
						            	  女<em></em>
						              	<input type="radio" name="re_sex" value="2"> 
						            </li>
						          </ul>  
						      </td>
						    </tr>
						    ...
						    <tr>
						      ...
						      <td colspan="3">
								  ...
								  <div class="boxUpDown boxUpDown_410 dn" id="box_currentState" style="display: none;">
						          	  ...
						          	  <li id="{{$val->pro_id}}">{{$val->pro_name}}</li> 
						          	  @endforeach        
						          	  </ul>
						          </div>  
						      </td>
