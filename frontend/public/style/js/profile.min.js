...
$(function() {
    ...
    function(a) {
        ...
        var b = $(this).attr('id');
        var c= $(this).text();
        $("#select_topDegree").val(c).css("color", "#333").removeClass("select_focus"),
        $("#topDegree").val(b),
        $("#box_topDegree").hide(),
    ...
    function(a) {
        ...
        var b = $(this).attr('id');
        var c = $(this).text();
        $("#select_workyear").val(c).css("color", "#333").removeClass("select_focus"),
        $("#workyear").val(b),
        $("#box_workyear").hide(),
    ...
    function(a) {
        ...
        var b = $(this).attr('id');
        var c = $(this).text();
        $("#select_currentState").val(c).css("color", "#333").removeClass("select_focus"),
        $("#currentState").val(b),
        $("#box_currentState").hide(),
